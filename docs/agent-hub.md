...
2. **Payment Allocation:**
   - **Solver Nodes** receive the highest portion of the payment for providing accurate responses.
   - **Retrieval Nodes** (nodes that contribute relevant documents) receive micropayments based on the quality and relevance of their retrieved data.
   - **Validation Nodes** (nodes involved in consensus and verification) receive a smaller portion for finalizing and attesting the correctness of responses.
